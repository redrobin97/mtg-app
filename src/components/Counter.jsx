...
export default function Counter() {
  ...
  return (
    <div className="h-full flex flex-row space-x-2 items-center justify-center bg-gray-300 text-center border-l-2 border-black">
      <button
      ...
      <div className="text-center text-6xl rounded-lg bg-white z-10 absolute h-20 w-20 flex items-center justify-center">
        {hp}
      </div>
      <button
